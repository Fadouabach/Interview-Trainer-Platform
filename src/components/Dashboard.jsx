            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        ...
                        <div style={{
                            ...
                            <div style={{ textAlign: 'center' }}>
                                <div style={{ fontSize: '3rem', fontWeight: 'bold', color: 'var(--secondary)' }}>85%</div>
                ...
                <div className="card">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        {[
                            { title: 'Frontend Basic Quiz', score: '92%', date: '2 hours ago' },
                            { title: 'Behavioral Mock', score: '78%', date: 'Yesterday' },
                            { title: 'System Design', score: 'Pending', date: '2 days ago' },
                        ].map((item, idx) => (
                            <div key={idx} style={{
                                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                                paddingBottom: '1rem', borderBottom: idx < 2 ? '1px solid var(--border-subtle)' : 'none'
                            }}>
                                <div>
                                ...
                                <div style={{
                                    background: item.score === 'Pending' ? '#f1f5f9' : '#dcfce7',
                                    color: item.score === 'Pending' ? '#64748b' : '#166534',
