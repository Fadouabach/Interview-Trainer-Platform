                    ...
                    <div key={e._id || e.id} className="card" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                            <div style={{ display: 'flex', gap: '1.5rem' }}>
                                <div style={{ width: '80px', height: '80px', borderRadius: '16px', background: '#f1f5f9', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <div style={{ textAlign: 'right' }}>
                                <div style={{ fontSize: '1.5rem', fontWeight: '800', color: '#1e293b' }}>${e.price || '50'}</div>
                                <div style={{ fontSize: '0.8rem', color: '#64748b' }}>per session</div>
                                <button onClick={() => handleDelete(e._id || e.id)} style={{ marginTop: '1rem', background: '#fee2e2', border: 'none', color: '#dc2626', padding: '0.5rem 1rem', borderRadius: '8px', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontWeight: '600', fontSize: '0.85rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem', borderTop: '1px solid #f1f5f9', paddingTop: '1.5rem' }}>
                            <div>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                                    ...
                                    {(!e.skills || e.skills.length === 0) && <span style={{ color: '#94a3b8', fontSize: '0.85rem' }}>No skills listed</span>}
                                </div>
                            </div>
                            <div>
                                ...
                                <div style={{ marginTop: '2rem', padding: '1rem', background: '#f8fafc', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
                                    <div style={{ fontSize: '0.8rem', color: '#64748b', marginBottom: '0.25rem' }}>Contact Email</div>
                                    <div style={{ fontWeight: '600', fontSize: '0.9rem' }}>{e.email}</div>
                                    {e.phone && (
                                        <>
                                            <div style={{ fontSize: '0.8rem', color: '#64748b', marginTop: '0.75rem', marginBottom: '0.25rem' }}>Phone Number</div>
